    ...
    public void openBaseMenu(Player player) {
        ...
        if (canOpenNpc(player)) {
            if (EventManager.HALLOWEEN) {
                if (player.NhanKeoHayBiGheoNpc_1 == 0) {
                ...
                if (player.canReward_PiLong) {
                    this.createOtherMenu(player, ConstNpc.MENU_PI_LONG,
                        ...
                        "Giao PiLong");
                    return;
                } else if (player.NhanLiXiForNPC_20 == 0) {
                                ...
                                case 0:
                                    ...
                                    if (Util.isTrue(50, 90)) {
                                        if (ThiepChucTet1 != null && ThiepChucTet1.quantity >= 1) {
                                            ...
                                            Service.gI().sendThongBao(player, "Chúc Appule thành công, Bạn nhận được " + HongNgoc + " hồng ngọc");
                                            Service.gI().sendThongBao(player, "Chúc Appule thành công, Bạn nhận được " + QuantityThoiVang + " thỏi vàng");
                                            return;
                                        } 
                                        ...
                                        if (ThiepChucTet1 != null && ThiepChucTet1.quantity >= 1) {
                                            InventoryService.gI().subQuantityItemsBag(player, ThiepChucTet1, 1);
                                            InventoryService.gI().sendItemBag(player);
                                            Service.gI().sendThongBao(player, "Chúc Appule thành công");
