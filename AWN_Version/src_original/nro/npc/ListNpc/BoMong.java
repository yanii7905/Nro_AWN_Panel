                    ...
                    case 0: {
                        if (player.getSession().tongnap >= 50000) {
                            if (player.mocnap[0] == 1) {
                                Service.gI().sendThongBao(player, "️Bạn đã nhận quà mốc 50K rồi!");
                                break;
                            }

                            // ⚙️ Pool riêng từng hành tinh
                            short[] poolTL;
                    ...
                    case 2: {
                        if (player.getSession().actived) {
                            if (player.mocnap[2] == 1) {
                                Service.gI().sendThongBao(player, "️ Bạn đã nhận quà mốc Thành Viên rồi!");
                                break;
                            }
