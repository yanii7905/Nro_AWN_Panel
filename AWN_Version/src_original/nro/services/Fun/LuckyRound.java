...
public class LuckyRound {
    ...
    private List<Supplier<Item>> buildItemPool(boolean vip) {
        ...
        if (EventManager.HALLOWEEN) {
            ...
            if (e != null) addEventItemMultipleTimes(pool, () -> LuckyRoundEventItems.getHalloweenItem(vip), 4);
        }
