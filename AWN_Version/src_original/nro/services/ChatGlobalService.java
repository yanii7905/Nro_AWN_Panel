...
public class ChatGlobalService implements Runnable {
    ...
    private static final String[] BAD_WORDS = {
        ...
        "d m", "đ m", "c m", "c l", "đ ḿ", "d . m", "đ.ịt", "đ ị t", "l ồ n", "c ặ c", "b uồ i", "bố mày", "mẹ mày",
        ...
        "hack", "bug", "cheat", "tool", "mod", "auto", "speed", "bypass", "onehit", "xuyên tường",
        "crack", "keylogger", "aimbot", "script", "trainer", "godmode", "inject", "memory edit",
        "speedhack", "wallhack", "exploit", "bot", "dll", "modmenu", "no recoil", "antiban"
    };
