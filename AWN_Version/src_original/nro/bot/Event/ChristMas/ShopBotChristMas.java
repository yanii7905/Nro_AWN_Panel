package nro.bot.Event.ChristMas;
...
public class ShopBotChristMas {
    ...
    public ShopBotChristMas(int item , int traodoi , int slot){
        this.idItem = item;
        this.idItTd = traodoi;
        this.slot = slot;
    }
   
    public ShopBotChristMas(ShopBotChristMas shop){
