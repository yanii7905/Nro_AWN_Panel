package nro.bot.Event.LunaNewYear;
...
public class ShopBotLunaNewYear {
    ...
    public ShopBotLunaNewYear(int item , int traodoi , int slot){
        this.idItem = item;
        this.idItTd = traodoi;
        this.slot = slot;
    }
   
    public ShopBotLunaNewYear(ShopBotLunaNewYear shop){
