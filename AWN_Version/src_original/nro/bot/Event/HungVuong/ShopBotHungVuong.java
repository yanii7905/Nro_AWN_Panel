package nro.bot.Event.HungVuong;
...
public class ShopBotHungVuong {
    ...
    public ShopBotHungVuong(int item , int traodoi , int slot){
        this.idItem = item;
        this.idItTd = traodoi;
        this.slot = slot;
    }
   
    public ShopBotHungVuong(ShopBotHungVuong shop){
