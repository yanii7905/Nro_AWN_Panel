...
public class Gogeta extends Boss {
    ...
    public Gogeta() throws Exception {
        super(TRUNGTHU_EVENT, BossID.GOGETA, true, true, false, false, BossesData.GOGETA);
    }
    ...
    public void afk() {
        if (playerReward.isPl() && !isReward && this.zone != null) {
            ItemMap it = new ItemMap(this.zone, 1685, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), playerReward.id);
            it.addOptionParam(50, 28);
            it.addOptionParam(77, 28);
            it.addOptionParam(103, 28);
            it.addOptionParam(5, 25);
            ...
            if (Util.isTrue(50, 100)) {
                ItemMap vp = new ItemMap(this.zone, 1699, 1, this.location.x + Util.nextInt(-20, 20), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), playerReward.id);
