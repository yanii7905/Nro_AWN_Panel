package nro.boss.dungeon.SnakeWay;
...
public class Nadic extends Boss {
    ...
    public Nadic(Zone zone, Clan clan, long dame, long hp) throws Exception {
        super(PHOBANCDRD, BossID.NADIC, new BossData(
                ...
                new int[][]{
                    {Skill.GALICK, 7, 1000},
                    {Skill.TAI_TAO_NANG_LUONG, 1, 30000},},//skill
                new String[]{},
                new String[]{},
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(100, 100)) {
            ItemMap it = new ItemMap(this.zone, Util.nextInt(16, 18), 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), -1);
