...
public class TrungUyTrang extends Boss {
    ...
    public TrungUyTrang(Zone zone, long dame, long hp) throws Exception {
        super(PHOBANDT, BossID.TRUNG_UY_TRANG, new BossData(
                ...
                new int[]{59}, //map join
                new int[][]{
                    {Skill.DRAGON, 1, 1000}, {Skill.KAMEJOKO, Util.nextInt(4, 6), 4000},},
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(100, 100)) {
            ...
            ItemMap it2 = new ItemMap(this.zone, 611, 1, this.location.x + Util.nextInt(-15, 15), this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), plKill.id);
