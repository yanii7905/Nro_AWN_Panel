...
public class TrungUyThep extends Boss {
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(100, 100)) {
            ...
            ItemMap vang = new ItemMap(this.zone, 190, 31000, this.location.x + Util.nextInt(-50, 50), this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), plKill.id);
            Service.gI().dropItemMap(this.zone, vang);
            ItemMap vang2 = new ItemMap(this.zone, 190, 31000, this.location.x + Util.nextInt(-50, 50), this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), plKill.id);
    ...
    public synchronized double injured(Player plAtt, double damage, boolean piercing, boolean isMobAttack) {
        ...
        if (Util.isTrue(40, 110)) {
            ItemMap vang = new ItemMap(this.zone, Util.nextInt(188, 190), Util.nextInt(20000, 31000), this.location.x + Util.nextInt(-50, 50), this.zone.map.yPhysicInTop(this.location.x, this.location.y), -1);
