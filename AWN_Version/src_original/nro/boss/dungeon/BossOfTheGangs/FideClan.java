...
public class FideClan extends Boss {
    ...
    private void dropCt(int x) {
        ItemMap it = new ItemMap(zone, 407, 1, this.location.x + x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), -1);
    ...
    private void dropItem() {
        for (int i = 0; i < Util.nextInt(1, 2); i++) {
            ItemMap it = new ItemMap(zone, 1150, 1, this.location.x + Util.nextInt(-100, 100), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), -1);
            it.addOptionParam(86, 0);
            it.addOptionParam(30, 0);
            Service.gI().dropItemMap(this.zone, it);
        }
        for (int i = 0; i < Util.nextInt(1, 2); i++) {
            ItemMap it = new ItemMap(zone, 1151, 1, this.location.x + Util.nextInt(-100, 100), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), -1);
            it.addOptionParam(86, 0);
            it.addOptionParam(30, 0);
            Service.gI().dropItemMap(this.zone, it);
        }
        for (int i = 0; i < Util.nextInt(1, 2); i++) {
            ItemMap it = new ItemMap(zone, 1152, 1, this.location.x + Util.nextInt(-100, 100), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), -1);
            it.addOptionParam(86, 0);
            it.addOptionParam(30, 0);
            Service.gI().dropItemMap(this.zone, it);
        }
        for (int i = 0; i < Util.nextInt(1, 2); i++) {
            ItemMap it = new ItemMap(zone, 1153, 1, this.location.x + Util.nextInt(-100, 100), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), -1);
            it.addOptionParam(86, 0);
            it.addOptionParam(30, 0);
            Service.gI().dropItemMap(this.zone, it);
        }
        for (int i = 0; i < Util.nextInt(1, 2); i++) {
            ItemMap it = new ItemMap(zone, 1154, 1, this.location.x + Util.nextInt(-100, 100), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), -1);
            it.addOptionParam(86, 0);
            it.addOptionParam(30, 0);
            Service.gI().dropItemMap(this.zone, it);
        }
