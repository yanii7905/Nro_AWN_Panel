...
//        return LOGIN_LOCKS.computeIfAbsent(username.toLowerCase().trim(), k -> new Object());
//    }
//}
//
//
...
//        }
        ...
        synchronized (getLoginLock(username)) {
            ...
            try {
                ...
                // chặn trường hợp hiếm khi 1 session khác vừa online xong
                Player onlineByUser = Client.gI().getPlayerByUser(this.userId);
                if (onlineByUser != null
                        && onlineByUser != pl
                        && onlineByUser.getSession() != null
                        && onlineByUser.getSession() != this) {
