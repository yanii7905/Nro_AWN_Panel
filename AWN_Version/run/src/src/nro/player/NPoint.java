...
public class NPoint {
    ...
    private void setHpMax() {
        ...
        if (this.player.Detu != null && this.player.fusion.typeFusion != ConstPlayer.NON_FUSION) {
            if (this.player.Detu.typeDeTu >= 5) {
                hpMax += this.player.Detu.nPoint.hpMax * this.player.getPointfusion().getHpFusion() / 100L;
            }
        }
    ...
    private void setMpMax() {
        ...
        if (this.player.Detu != null && this.player.fusion.typeFusion != ConstPlayer.NON_FUSION) {
            if (this.player.Detu.typeDeTu >= 5) {
                mpMax += this.player.Detu.nPoint.mpMax * this.player.getPointfusion().getMpFusion() / 100L;
            }
        }
