package nro.bot.Event.Halloween;
...
public class ShopBotHalloween {
    ...
    public ShopBotHalloween(int item , int traodoi , int slot){
        this.idItem = item;
        this.idItTd = traodoi;
        this.slot = slot;
    }
   
    public ShopBotHalloween(ShopBotHalloween shop){
