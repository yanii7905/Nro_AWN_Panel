            ...
            switch (player.iDMark.getTypeInput()) {
                ...
                case PASS_ADMIN: {
                    if (player.isFounder()) {
                        ...
                        String matKhauCuaToi = "6677";
                        Logger.warning("DEBUG INPUT LENGTH = " + text.length);
for (int i = 0; i < text.length; i++) {
    Logger.warning("text[" + i + "] = [" + text[i] + "]");
}
...
//---------------------------------------------------------------------------------------                    
                        ...
                        if (pBuffItem != null) {
                            ...
                            if (idItemBuff == -1) {
                                ...
                                if (idOptionSKH == 127) {
                                    ...
                                    itemBuffTemplate.itemOptions.add(new ItemOption(142, 0));
    ...
    public void createFormDoiNgocHong(Player pl) {
        createForm(pl, DOI_NGOC_HONG, "Đổi Hồng Ngọc (Không khuyến cáo sử dụng tính năng này)",
                new SubInput("Nhập số tiền VNĐ muốn đổi", NUMERIC));
    }
