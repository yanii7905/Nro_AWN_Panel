...
public class SonTinh extends Boss {
    ...
    public SonTinh() throws Exception {
        super(HUNGVUONG_EVENT, BossID.SON_TINH, true, true, false, false, BossesData.SON_TINH);
    }
    ...
    public void afk() {
        if (playerReward.isPl() && !isReward && this.zone != null) {
            ItemMap it = new ItemMap(this.zone, 422, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), playerReward.id);
