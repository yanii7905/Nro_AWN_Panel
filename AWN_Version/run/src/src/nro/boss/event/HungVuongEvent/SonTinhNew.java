...
public class SonTinhNew extends Boss {
    ...
    public SonTinhNew() throws Exception {
        super(HUNGVUONG_EVENT, BossID.SON_TINH_NEW, true, true, false, false, BossesData.SON_TINH_NEW);
    }
    ...
    public void afk() {
        if (playerReward.isPl() && !isReward && this.zone != null) {
            if (Util.isTrue(50, 100)) {
                ItemMap it = new ItemMap(this.zone, 1866, 1, this.location.x + Util.nextInt(-30, 30), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), playerReward.id);
                it.addOptionParam(50, 17);
                it.addOptionParam(14, 11);
                if (Util.isTrue(99, 100)) {
                    it.addOptionParam(93, Util.nextInt(3, 7));
                }
                Service.gI().dropItemMap(this.zone, it);
            }
            ItemMap it = new ItemMap(this.zone, 1886, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), playerReward.id);
            it.addOptionParam(50, 27);
            it.addOptionParam(10, 15);
            it.addOptionParam(77, 22);
