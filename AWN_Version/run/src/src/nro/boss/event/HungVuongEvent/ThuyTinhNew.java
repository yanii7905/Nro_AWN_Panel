    ...
    public void afk() {
        if (playerReward.isPl() && !isReward && this.zone != null) {
            if (Util.isTrue(50, 100)) {
                ItemMap it = new ItemMap(this.zone, 1865, 1, this.location.x + Util.nextInt(-30, 30), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), playerReward.id);
            ...
            ItemMap it = new ItemMap(this.zone, 1885, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), playerReward.id);
