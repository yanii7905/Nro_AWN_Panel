...
public class NguyetThan extends Boss {
    ...
    public NguyetThan() throws Exception {
        super(TRUNGTHU_EVENT, BossID.NGUYETTHAN,false, true, false, false, BossesData.NGUYETTHAN);
    }
    ...
    public void afk() {
        if (playerReward.isPl() && !isReward && this.zone != null) {
            for (int i = 0; i < Util.nextInt(1, 5); i++) {
                ItemMap it = new ItemMap(this.zone, 1312, 1, this.location.x + Util.nextInt(-50, 50), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), playerReward.id);
            ...
            if (KiemGo != null) {
                ItemMap it = new ItemMap(this.zone, 1277, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), playerReward.id);
                it.addOptionParam(77, 25);
                it.addOptionParam(103, 25);
                it.addOptionParam(50, 25);
                it.addOptionParam(94, 12);
                it.addOptionParam(14, 10);
                it.addOptionParam(108, 5);
