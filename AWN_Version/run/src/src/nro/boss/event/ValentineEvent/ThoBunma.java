    ...
    public void joinMap() {
        ...
        if (this.zone != null) {
            try {
                ...
                while (zoneid < this.zone.map.zones.size() && BossManager.gI().checkBosses(this.zone.map.zones.get(zoneid), BossID.THO_BUNMA)) {
                    zoneid++;
                }
        ...
        if (Util.canDoWithTime(this.lastTimeAttack, 500)) {
            ...
            if (this.zone.equals(pl.zone)) {
                ...
                if (dis <= 300) {
                    ...
                    afk = false;
                    // => thay cho canReward_TuanLoc: gọi luôn Service thông báo
