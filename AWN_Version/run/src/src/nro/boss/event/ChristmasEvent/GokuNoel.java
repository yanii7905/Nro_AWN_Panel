    ...
    public void reward(Player plKill) {
        ...
        if (EventManager.CHRISTMAS) {
            if (Util.isTrue(100, 100)) {
                ItemMap it = new ItemMap(this.zone, 1424, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
            ...
            for (int i = 0; i < Util.nextInt(3, 5); i++) {
                ItemMap itemMap = new ItemMap(this.zone, Util.nextInt(925, 927), 1, this.location.x + Util.nextInt(-80, 80), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
            ...
            for (int i = 0; i < Util.nextInt(5, 10); i++) {
                ItemMap itemMap = new ItemMap(this.zone, Util.nextInt(928, 931), 1, this.location.x + Util.nextInt(-80, 80), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
                itemMap.addOptionParam(87, 0);
                itemMap.addOptionParam(30, 0);
                itemMap.addOptionParam(93, 35);
                Service.gI().dropItemMap(this.zone, itemMap);
            ...
            for (int i = 0; i < 5; i++) {
                ItemMap itemMap = new ItemMap(this.zone, Util.nextInt(925, 927), 1, this.location.x + Util.nextInt(-80, 80), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), -1);
                itemMap.addOptionParam(87, 0);
                itemMap.addOptionParam(30, 0);
                itemMap.addOptionParam(93, 35);
                Service.gI().dropItemMap(this.zone, itemMap);
            ...
            for (int i = 0; i < 10; i++) {
                ItemMap itemMap = new ItemMap(this.zone, Util.nextInt(928, 931), 1, this.location.x + Util.nextInt(-80, 80), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), -1);
                itemMap.addOptionParam(87, 0);
                itemMap.addOptionParam(30, 0);
                itemMap.addOptionParam(93, 35);
                Service.gI().dropItemMap(this.zone, itemMap);
        ...
        if (!this.isDie()) {
            ...
            if (this.nPoint.hp <= 1_000_000_000) {
                if (Util.isTrue(5, 100)) {
                    ItemMap it = new ItemMap(this.zone, 648, 1, this.location.x + Util.nextInt(-50, 50), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), -1);
