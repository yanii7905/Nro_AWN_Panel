...
public class MaBu2H extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(10, 100)) {
            Service.gI().dropItemMap(this.zone, Util.ratiDTL(zone, Manager.itemIds_TL[randomDo], 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id));
        }
    }
