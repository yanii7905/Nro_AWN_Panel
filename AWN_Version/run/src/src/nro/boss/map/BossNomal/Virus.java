...
public class Virus extends Boss {
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(20, 100)) {
            ItemMap it = new ItemMap(this.zone, 459, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
        ...
        for (int i = 0; i < Util.nextInt(5, 15); i++) {
            ItemMap it = new ItemMap(this.zone, 861, 1, this.location.x + Util.nextInt(-50, 50), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id);
            Service.gI().dropItemMap(this.zone, it);
        }
        for (int i = 0; i < Util.nextInt(5, 10); i++) {
            ItemMap it = new ItemMap(this.zone, 861, 1, this.location.x + Util.nextInt(-50, 50), this.zone.map.yPhysicInTop(this.location.x, this.location.y - 24), -1);
            Service.gI().dropItemMap(this.zone, it);
        }
    }
