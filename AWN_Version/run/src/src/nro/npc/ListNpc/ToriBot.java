            ...
            if (player.iDMark.isBaseMenu()) {
                ...
                switch (select) {
                    case 0:
                        if (player.getSession().Vip_Point > 19) {
                            Service.gI().sendThongBao(player, "Đã đạt giới hạn tối đa mua VIP");
                            return;
                        }
                        ...
                        Service.gI().sendThongBao(player, "Mua thành công VIP 1, bạn đã mua " + player.getSession().Vip_Point + "/20 lượt VIP.");
                        DetuService.gI().createNormalPetByGender(player, player.gender);
                ...
                switch (select) {
                    case 0:
                        ...
                        DatabaseUpdater.addVip_byPlayer(player, 1);
                        Service.gI().sendThongBao(player, "Mua thành công VIP 2, bạn đã mua " + player.getSession().Vip_Point + "/20 lượt VIP.");
                        DetuService.gI().createNormalPetByGender(player, player.gender);
                ...
                switch (select) {
                    case 0:
                        ...
                        DatabaseUpdater.addVip_byPlayer(player, 1);
                        Service.gI().sendThongBao(player, "Mua thành công VIP 3, bạn đã mua " + player.getSession().Vip_Point + "/20 lượt VIP.");
                        DetuService.gI().createNormalPetByGender(player, player.gender);
                ...
                switch (select) {
                    case 0:
                        ...
                        DatabaseUpdater.addVip_byPlayer(player, 1);
                        Service.gI().sendThongBao(player, "Mua thành công VIP 4, bạn đã mua " + player.getSession().Vip_Point + "/20 lượt VIP.");
                        DetuService.gI().createNormalPetByGender(player, player.gender);
                    ...
                    case 0:
                        switch (player.typeVip) {
                            case 1:
                                ...
                                if (player.Detu != null) {
                                    DetuService.gI().deletePet(player);
                                }
                                DatabaseUpdater.addVip_byPlayer(player, 1);
                                Service.gI().sendThongBao(player, "Mua thành công VIP 1, bạn đã mua " + player.getSession().Vip_Point + "/20 lượt VIP.");
                                DetuService.gI().createNormalPetByGender(player, player.gender);
