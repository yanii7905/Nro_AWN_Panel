...
public class NgoKhong extends Boss {
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(100, 100)) {
            ItemMap it = new ItemMap(this.zone, 1563, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x, this.location.y), plKill.id);
    ...
    if (System.currentTimeMillis() - lastTimeBlame > Util.nextInt(10000, 20000)) {
            this.chat("500 Năm Trước Ta Đại Láo Thiên Cung Ta Còn Không Sợ");
