...
public class BossesData {
    ...
    public static final BossData ZAMAS = new BossData(
            ...
            new int[]{97}, //map join
            new int[][]{
                {Skill.DICH_CHUYEN_TUC_THOI, 7, 40000},
    ...
    //************************************************************************** Boss hủy diệt
    public static final BossData WHIS_2 = new BossData(
            "Thiên sứ Whis", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{838, 839, 840, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            999999999, //dame
            new long[]{100L}, //hp
            new int[]{202}, //map join
            new int[][]{
                {Skill.THOI_MIEN, Util.nextInt(1, 7), Util.nextInt(120000, 240000)},},//skill
            new String[]{}, //text chat 1
            new String[]{}, //text chat 2
            new String[]{}, //text chat 3
            REST_20_M, //second rest
            new int[]{BossID.BERUS}
    );
    public static final BossData BERUS = new BossData(
            ...
            new int[]{202},
            new int[][]{
                {Skill.MASENKO, 1, Util.nextInt(500, 1000)},
                {Skill.DRAGON, 7, Util.nextInt(500, 1000)},},
            new String[]{}, //text chat 1
            new String[]{},
            new String[]{},
    ...
    public static final BossData CHAMPA = new BossData(
            ...
            new int[][]{
                {Skill.MASENKO, 1, Util.nextInt(500, 1000)},
                {Skill.DEMON, 7, Util.nextInt(500, 1000)},},
            new String[]{}, //text chat 1
            new String[]{}, //text chat 2
            new String[]{}, //text chat 3
            TypeAppear.APPEAR_WITH_ANOTHER
