<p align="center">
  <a href="https://github.com/yanii7905/Nro_AWN_Panel">
  ...
  <h1 align="center">NRO - AWN(Panel)</h1>
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/yanii7905/Nro_AWN_Panel/issues">Báo lỗi / Đóng góp</a>
  </p>
</p>

![Repo Size](https://img.shields.io/github/repo-size/yanii7905/Nro_AWN_Panel?color=blue&style=flat-square)
![Languages](https://img.shields.io/github/languages/count/yanii7905/Nro_AWN_Panel?style=flat-square)
...
- Truy cập vào `phpMyAdmin`, tạo mới một cơ sở dữ liệu (Database) với tên `awnv3`.
- Tiến hành **Import** file cơ sở dữ liệu (`.sql`) đi kèm vào database vừa tạo.

### Bước 3: Khởi động Server
- Nhấp đúp chuột vào file `Run.bat` nằm trong thư mục **AWN_Version**
**Lưu Ý:** Phải mở Apache và MySQL trong XAMPP trước rồi mới chạy Sever

### Bước 4: Trải nghiệm game
- Truy cập vào đường dẫn thư mục `Mod_Local/Panel Game.exe` để mở Client và bắt đầu bước chân vào thế giới Ngọc Rồng!

---

## 💡 Thông tin thêm
* Nếu muốn chơi chung máy tính và điện thoại thì sửa IP thành IP mạng wifi (LAN). IP mặc định: 127.0.0.1:14445
* Dự án phục vụ mục đích lưu trữ mã nguồn cá nhân, học tập và trải nghiệm ngoại tuyến. 
* Mọi đóng góp hoặc báo lỗi xin vui lòng tạo [Issue](https://github.com/yanii7905/Nro_AWN_Panel/issues) để được hỗ trợ.